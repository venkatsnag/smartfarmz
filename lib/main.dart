...
import './screens/buyers_overview_screen.dart';
...
import './screens/investor_home_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    ChangeNotifierProxyProvider<Auth, Orchards>(
      create: (_) => Orchards(null , null ,[]),
         update: (ctx, auth, previusOrchards) => Orchards(auth.token, auth.userId,
      ...
      ChangeNotifierProxyProvider<Auth, CropExpenses>(
       create: (_) => CropExpenses(null , null ,[]),
         update: (ctx, auth, previusCropExpenses) => CropExpenses(auth.token, auth.userId,
      ...
      ChangeNotifierProxyProvider<Auth, CropHarvest>(
       create: (_) => CropHarvest(null , null ,[]),
         update: (ctx, auth, previusCropHarvest) => CropHarvest(auth.token, auth.userId,
      ...
      ChangeNotifierProxyProvider<Auth, FertiPestis>(
       create: (_) => FertiPestis(null , null ,[]),
         update: (ctx, auth, previusFertiPestis) => FertiPestis(auth.token, auth.userId,
      ...
      ChangeNotifierProxyProvider<Auth, MarketPrices2>(
        create: (_) => MarketPrices2(null , null ,[]),
         update: (ctx, auth, previusMarketPrices2) => MarketPrices2(auth.token, auth.userId,
      previusMarketPrices2 == null ? [] : previusMarketPrices2.items),
      ), 

      ChangeNotifierProxyProvider<Auth, UserProfiles>(
        create: (_) => UserProfiles(null , null , null , null ,[]),
         update: (ctx, auth, previusUserProf) => UserProfiles(auth.token, auth.userId, 
         auth.userType, auth.userEmail, previusUserProf == null ? [] : previusUserProf.items),
      ), 

        ChangeNotifierProxyProvider<Auth, Users>(
        create: (_) => Users(null , null , null ,[]),
         update: (ctx, auth, previusUserProf) => Users(auth.token, auth.userId, auth.userType,
      ...
      ChangeNotifierProxyProvider<Auth, UserRating>(
       create: (_) => UserRating(null , null ,[]),
         update: (ctx, auth, previusUserRatings) => UserRating(auth.token, auth.userId,
      previusUserRatings == null ? [] : previusUserRatings.items),
       ...
       create: (_) => CropLandNotes(null , null ,[]),
         update: (ctx, auth, previusCropNotes) => CropLandNotes(auth.token, auth.userId,
      previusCropNotes == null ? [] : previusCropNotes.items),
      ),

           ChangeNotifierProxyProvider<Auth, Machinery>(
       create: (_) => Machinery(null , null ,[]),
         update: (ctx, auth, previusMachinery) => Machinery(auth.token, auth.userId,
   ...
   child: Consumer<Auth>
      (builder: (ctx, auth, _) => MaterialApp(
        ...
        home: auth.isAuth ? GuestHomeScreen()  : 
        //CropsOverviewScreen() : 
        FutureBuilder(
        ...
        routes: {
          ...
          AddExpenseScreen.routeName: (ctx) => AddExpenseScreen(),
           ...
           PesticidesOverviewScreen.routeName: (ctx) => PesticidesOverviewScreen(),
          BuyersOverviewScreen.routeName: (ctx) => BuyersOverviewScreen(),
          ...
          GuestHomeScreen.routeName: (ctx) => GuestHomeScreen(),
           ...
           BuyerHomeScreen.routeName: (ctx) => BuyerHomeScreen(),
          ...
          CropsForSaleOverviewScreen.routeName: (ctx) => CropsForSaleOverviewScreen(),
          CropsForSaleOverviewScreenUser.routeName: (ctx) => CropsForSaleOverviewScreenUser(),
          CropForSaleDetailScreen.routeName: (ctx) => CropForSaleDetailScreen(),
          CropForSaleDetailScreenUser.routeName: (ctx) => CropForSaleDetailScreenUser(),
          CropSaleAnouncementScreen.routeName: (ctx) => CropSaleAnouncementScreen(),
           ...
           EditFieldScreen.routeName: (ctx) => EditFieldScreen(),
            CropsOnLandOverviewScreen.routeName: (ctx) => CropsOnLandOverviewScreen(),
           ...
           MachineryDetailScreen.routeName: (ctx) => MachineryDetailScreen(),
            ...
            InvestorHomeScreen.routeName: (ctx) => InvestorHomeScreen(),
            ContactUs.routeName: (ctx) => ContactUs(),
            CropInvestmentSeekAnouncementScreen.routeName: (ctx) => CropInvestmentSeekAnouncementScreen(),
            FarmersForInvestmentOverviewScreen.routeName: (ctx) => FarmersForInvestmentOverviewScreen(),
            CropForInvestmentDetailScreen.routeName: (ctx) => CropForInvestmentDetailScreen(),
