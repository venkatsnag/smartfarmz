...
// Sign in label to sign into website.
  ...
  // Title for Buyer.
  String get allBuyers;

   // Title for Lands.
  String get myLands;

    // Title for Mylands.
  String get myLandTitle;

  // Title for Mylands.
  String get cropOnLandTitle;

  // Market prices.
  String get marketPrices;

// Market prices.
  String get crop_title;
// Market prices.
  String get market_prices;

  // image upload confirmation.
  String get imageUploadDialogue;
...
//  Title for cropExpenses.
  String get cropExpensesTitle;

//  Title for cropExpenses.
  String get landExpensesTitle;

  //  Title for cropExpenses.
  String get cropNotesTitle;

//  Title for cropExpenses.
  String get landNotesTitle;
...
//  Title for cropExpenses.
  ...
  //  Title for cropExpenses.
  String get onlyFarmersTitle;

  //  Title for cropExpenses.
  String get onlyFarmersText;

  //  Title for cropExpenses.
  String get onlyBuyersTitle;

  //  Title for cropExpenses.
  String get onlyBuyersText;


  //  Title for cropExpenses.
  String get onlyInvestorsTitle;

  //  Title for cropExpenses.
  String get onlyInvestorsText;

  //  Title for cropExpenses.
  String get cropSalesTitle;

   //  Title for cropExpenses.
  String get noCropText;

  //  Title for cropExpenses.
  String get noLandsText;

//  Title for cropExpenses.
  String get noCropForSale;
  

    //  Title for cropHarvestTitle.
  String get cropHarvestTitle;

    //  Title for cropforSaleUser.
  String get myCropforSale;

    //  Title for cropforInvestments.
  String get cropforInvestments;
  ...
  //  Title for farmers.
  String get allFarmers;

  //  Title for crops.
  String get allCropsForSale;

  //  Title for purchases.
  String get myPurchases;

  //  Title for crops for sale.
 // String get cropsForSale;
 ...
 //  Title for farmers.
  String get farmer;
    ...
    // Title for crops.
  String get myCropTitle;

    // Title for crops.
  String get myInvestedCropTitle;
  // Title for Orchards.
  String get myOrchardTitle;

  // Password was updated on a different device and the user is required to sign in again
  String get bannerDemoText;

  // Show the Banner to for user to Signin.
  String get bannerSignIn;
    ...
    case 'te':
      {
        switch (locale.scriptCode) {
          case 'te':
            return gallery_localizations_te.loadLibrary().then((dynamic _) 
