...
class CropForInvestmentDetailScreen extends StatefulWidget {

  static const routeName = '/crop-for-investment-detail';

  @override
  _CropForInvestmentDetailScreenState createState() => _CropForInvestmentDetailScreenState();
}

class _CropForInvestmentDetailScreenState extends State<CropForInvestmentDetailScreen> {
...
int selectedIndex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    final loadedCrops = Provider.of<Crops>(context).findCropsForInvestmentsById(cropid);
              ...
              fit: BoxFit.cover,
               ...
               Stack(children: <Widget>[
                 Column(children: <Widget>[
                  ...
                  TextSpan(text: ' ${loadedCrops.title}'),
                  ],
                  ),
                  ),
                   RichText(
 ...
 RichText(
                  ...
                  RichText(
                     text: TextSpan(
                      text: 'Expected Total Crop cost : ',
                      
                    style: TextStyle(color: Colors.black.withOpacity(0.6), fontWeight: FontWeight.bold),
                    children: <TextSpan>[
      
                  TextSpan(text: ' ${loadedCrops.expectedTotalCropCost}'),
                  ],
                  ),
                  ),
                   RichText(
                  ...
                  TextSpan(text: ' ${loadedCrops.investmentNeeded}'),
                  ],
                  ),
                  ),
                      ...
                      RichText(
                     text: TextSpan(
                      text: 'Crop Start date : ',
                      
                    style: TextStyle(color: Colors.black.withOpacity(0.6), fontWeight: FontWeight.bold),
                    children: <TextSpan>[
      
                  TextSpan(text: ' ${loadedCrops.seedingDate}'.toString()),
                  ],
                  ),
                  ),
                      RichText(
                     text: TextSpan(
                      text: 'Expected Harvest Start date : ',
                      
                    style: TextStyle(color: Colors.black.withOpacity(0.6), fontWeight: FontWeight.bold),
                    children: <TextSpan>[
      
                  TextSpan(text: ' ${loadedCrops.expectedHarvestDate}'.toString()),
                  ],
                  ),
                  ),
