...
static const routeName = '/investor_home_screen';
  
  const InvestorHomeScreen({Key key, this.type}) : super(key: key);

  final InvestorHomeScreen type;
  ...
  List<_Photo> _photos(BuildContext context) {
    return [
      _Photo(
        ...
        title: GalleryLocalizations.of(context).myInvestedCropTitle,
       ...
       _Photo(
        ...
        subtitle: GalleryLocalizations.of(context).allFarmers,
      ), 
     _Photo(
        assetName: 'assets/img/orchads.jpg',
        navi: '/all-farmers-for-investments-overview',
        title: GalleryLocalizations.of(context).cropforInvestments,
   ...
   String userType = '${userData.userType}';
    ...
    return  Consumer<Auth>
      ...
      appBar: new AppBar(
          ...
          drawer:  userType == 'Investor'? AppDrwaer() : SizedBox(),
      body:
  ...
  Widget okButton = FlatButton(
    ...
    return showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
              title: Text(GalleryLocalizations.of(context).onlyInvestorsTitle,),
              content: Text(GalleryLocalizations.of(context).onlyInvestorsText,),
    actions: [
      okButton,
    ],);
        });
