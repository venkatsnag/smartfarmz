...
class EditHarvestScreen extends StatefulWidget {
  static const routeName = '/edit-cropHarvest';
  @override
...
final _descriptionFocusNode = FocusNode();
 ...
 var _editHarvest = CropHarvestItemNew(
    id: '',
    cropId: '',
    description: '',
    totalOutput :'',
...
if (picked != null && picked != selectedDate)
      setState(() {
        selectedDate = picked;
            print(selectedDate);
        return _editHarvest.harvestDate = picked;
  ...
  final dynamic harvestId = routes['id'];
  
     
   if(harvestId != null){
        _editHarvest = 
         Provider.of<CropHarvest>(context, listen: false).findById(harvestId); 
       
      _initValues = {
      'cropId': _editHarvest.cropId,
      
      'description': _editHarvest.description,
      'totalOutput' : _editHarvest.totalOutput,
      'units': _editHarvest.units,
       'supervisorName': _editHarvest.supervisorName,
        'totalWorkers': _editHarvest.totalWorkers,
      'harvestDate': _editHarvest.harvestDate.toString(),
      'id':_editHarvest.id,
...
if(_editHarvest.id != null){
await Provider.of<CropHarvest>(context, listen: false).updateHarvest(_editHarvest.id, _editHarvest);;
 await showDialog<void>(
          context: context,
          builder: (ctx) => AlertDialog(
            title: Text("Sucessful"),
            content: Text(
                "You have sucessfully edited harvest details."),
            actions: <Widget>[
              FlatButton(
                child: Text("Okay"),
                onPressed: () {
...
//Color method for text fields
   ...
   if(cType == 'crops'){
cropIdCrop = _editHarvest.cropId;
cropIdOrch = null;
cropIdLand = null;
            ...
            onFieldSubmitted: (_){ 
              ...
              onSaved: (value){
                ...
                units: _editHarvest.units,
                 supervisorName: _editHarvest.supervisorName,
                  totalWorkers: _editHarvest.totalWorkers,
                   harvestDate: _editHarvest.harvestDate,
          ...
          onSaved: (value){
              ...
              onChanged: (dynamic newValue) {
                setState(() {
                  ...
                  return _editHarvest.units = _selectedUom;
                });
              },
